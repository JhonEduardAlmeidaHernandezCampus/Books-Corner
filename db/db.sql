...
INSERT INTO administrator (name_User, tel_User, email_User, direccion_User) VALUES
...
INSERT INTO clients (id_Client, id_User_fk, name_Client, tel_Client, email_Client, direccion_Client) VALUES
...
INSERT INTO categories_books (name_Categorie) VALUES
('Fiction'),
('Science Fiction'),
('Mystery'),
('Romance'),
...
INSERT INTO books_description (id_Categorie_fk, name_Book, description, name_Author) VALUES
...
INSERT INTO status_inventory (name_Status) VALUES
('In Stock'),
('Out of Stock');

INSERT INTO inventory (id_Book_fk, id_Status_Inventory, quantity_Book) VALUES
(1, 1, 10),
(2, 2, 5),
(3, 1, 8),
(4, 2, 0),
...
INSERT INTO status_loan (name_Status) VALUES
('On Loan'),
('overdue'),
('Returned');

INSERT INTO loan (id_Client_fk, start_Loan, end_Loan, id_Status_Loan_fk, id_Inventory_fk, description, penalthy_Cost) VALUES
